...
test('D70: the four unbuilt operations are absent from the pinned contract', () => {
  ...
  // 427 -> 430: GetHolidayTypeSideTypes, SetHolidayTypeSideTypes, GetSideEffectiveHolidays (G-80).
  // Re-pinned deliberately.
  assert.equal(ids.size, 430, 'operation count moved off the pinned contract');
