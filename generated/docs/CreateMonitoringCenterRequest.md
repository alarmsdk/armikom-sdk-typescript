...
```typescript
import type { CreateMonitoringCenterRequest } from ''
...
const example = {
  ...
  "fcmDatabaseUrl": null,
} satisfies CreateMonitoringCenterRequest
...
const exampleParsed = JSON.parse(exampleJSON) as CreateMonitoringCenterRequest
