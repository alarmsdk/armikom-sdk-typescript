...
```typescript
import type { BulkSmsFilterRequest } from ''
...
const example = {
  ...
  "approved": null,
  "dealerId": null,
} satisfies BulkSmsFilterRequest
...
const exampleParsed = JSON.parse(exampleJSON) as BulkSmsFilterRequest
