...
| [**updateSelf**](UserAdministrationApi.md#updateselfoperation) | **PUT** /v1/auth/me | Update own profile settings |



## changeOwnPassword

> changeOwnPassword(changeOwnPasswordRequest, xCorrelationId, idempotencyKey)
...
import type { ChangeOwnPasswordOperationRequest } from '';
...
async function example() {
  ...
  } satisfies ChangeOwnPasswordOperationRequest;
...
> OperatorUserDetailResponse createOperatorUser(createOperatorUserRequest, xCorrelationId, idempotencyKey)
...
import type { CreateOperatorUserOperationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | UUID idempotency key. When present, the server guarantees at-most-once execution for the same key+endpoint within 24 hours. (optional)
    idempotencyKey: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies CreateOperatorUserOperationRequest;

  try {
    const data = await api.createOperatorUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **createOperatorUserRequest** | [CreateOperatorUserRequest](CreateOperatorUserRequest.md) |  | |
| **xCorrelationId** | `string` | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. | [Optional] [Defaults to `undefined`] |
| **idempotencyKey** | `string` | UUID idempotency key. When present, the server guarantees at-most-once execution for the same key+endpoint within 24 hours. | [Optional] [Defaults to `undefined`] |

### Return type

[**OperatorUserDetailResponse**](OperatorUserDetailResponse.md)
...
import type { DeleteOperatorUserRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies DeleteOperatorUserRequest;

  try {
    const data = await api.deleteOperatorUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
import type { GetOperatorUserRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies GetOperatorUserRequest;

  try {
    const data = await api.getOperatorUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> OperatorUserListItemPagedResult listOperatorUsers(q, locked, active, cursor, limit, page, pageSize, offset, xCorrelationId)
...
import type { ListOperatorUsersRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies ListOperatorUsersRequest;

  try {
    const data = await api.listOperatorUsers(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
[**OperatorUserListItemPagedResult**](OperatorUserListItemPagedResult.md)
...
> Array&lt;RoleListItem&gt; listRoles(xCorrelationId)
...
[**Array&lt;RoleListItem&gt;**](RoleListItem.md)
...
> resetOperatorPassword(id, resetPasswordRequest, xCorrelationId, idempotencyKey)
...
import type { ResetOperatorPasswordRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | UUID idempotency key. When present, the server guarantees at-most-once execution for the same key+endpoint within 24 hours. (optional)
    idempotencyKey: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies ResetOperatorPasswordRequest;

  try {
    const data = await api.resetOperatorPassword(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> setRoleScopes(id, setRoleScopesRequest, xCorrelationId)
...
import type { SetRoleScopesOperationRequest } from '';
...
> setUserRoles(id, setUserRolesRequest, xCorrelationId)
...
import type { SetUserRolesOperationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies SetUserRolesOperationRequest;

  try {
    const data = await api.setUserRoles(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **id** | `string` |  | [Defaults to `undefined`] |
| **setUserRolesRequest** | [SetUserRolesRequest](SetUserRolesRequest.md) |  | |
| **xCorrelationId** | `string` | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. | [Optional] [Defaults to `undefined`] |
...
> unlockUser(id, xCorrelationId, idempotencyKey)
...
import type { UnlockUserRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | UUID idempotency key. When present, the server guarantees at-most-once execution for the same key+endpoint within 24 hours. (optional)
    idempotencyKey: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies UnlockUserRequest;

  try {
    const data = await api.unlockUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> updateOperatorUser(id, updateOperatorUserRequest, xCorrelationId)
...
import type { UpdateOperatorUserOperationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies UpdateOperatorUserOperationRequest;

  try {
    const data = await api.updateOperatorUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **id** | `string` |  | [Defaults to `undefined`] |
| **updateOperatorUserRequest** | [UpdateOperatorUserRequest](UpdateOperatorUserRequest.md) |  | |
| **xCorrelationId** | `string` | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. | [Optional] [Defaults to `undefined`] |
...
> OperatorUserDetailResponse updateSelf(updateSelfRequest, xCorrelationId)
...
import type { UpdateSelfOperationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies UpdateSelfOperationRequest;

  try {
    const data = await api.updateSelf(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **updateSelfRequest** | [UpdateSelfRequest](UpdateSelfRequest.md) |  | |
| **xCorrelationId** | `string` | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. | [Optional] [Defaults to `undefined`] |
