...
|------------- | ------------- | -------------|
| [**getCurrentUser**](AuthenticationApi.md#getcurrentuser) | **GET** /v1/auth/me | Get current user info |
| [**login**](AuthenticationApi.md#loginoperation) | **POST** /v1/auth/login | Authenticate with credentials |
| [**logout**](AuthenticationApi.md#logout) | **POST** /v1/auth/logout | Revoke refresh token |
| [**refreshToken**](AuthenticationApi.md#refreshtoken) | **POST** /v1/auth/refresh | Refresh an access token |



## getCurrentUser

> UserInfoResponse getCurrentUser(xCorrelationId)
...
> LoginResponse login(loginRequest, xCorrelationId, idempotencyKey)
...
| **423** | Locked |  * X-Correlation-Id - The correlation identifier for this request (echoed or generated). <br>  |
...
> logout(refreshRequest, xCorrelationId, idempotencyKey)
...
> RefreshResponse refreshToken(refreshRequest, xCorrelationId, idempotencyKey)
