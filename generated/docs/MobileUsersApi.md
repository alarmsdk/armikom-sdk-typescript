...
> MobileUserDetailResponse createMobileUser(createMobileUserRequest, xCorrelationId, idempotencyKey)
...
import type { CreateMobileUserOperationRequest } from '';
...
async function example() {
  ...
  } satisfies CreateMobileUserOperationRequest;

  try {
    const data = await api.createMobileUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **createMobileUserRequest** | [CreateMobileUserRequest](CreateMobileUserRequest.md) |  | |
...
[**MobileUserDetailResponse**](MobileUserDetailResponse.md)
...
> DeleteMobileUserResponse deleteMobileUser(id, xCorrelationId)
...
import type { DeleteMobileUserRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies DeleteMobileUserRequest;

  try {
    const data = await api.deleteMobileUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
[**DeleteMobileUserResponse**](DeleteMobileUserResponse.md)
...
> MobileUserDetailResponse getMobileUserById(id, xCorrelationId)
...
import type { GetMobileUserByIdRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies GetMobileUserByIdRequest;

  try {
    const data = await api.getMobileUserById(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
## linkMobileUserToSide

> LinkMobileUserResponse linkMobileUserToSide(sideId, linkMobileUserRequest, xCorrelationId, idempotencyKey)
...
import type { LinkMobileUserToSideRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | UUID idempotency key. When present, the server guarantees at-most-once execution for the same key+endpoint within 24 hours. (optional)
    idempotencyKey: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies LinkMobileUserToSideRequest;

  try {
    const data = await api.linkMobileUserToSide(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
| **linkMobileUserRequest** | [LinkMobileUserRequest](LinkMobileUserRequest.md) |  | |
| **xCorrelationId** | `string` | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. | [Optional] [Defaults to `undefined`] |
| **idempotencyKey** | `string` | UUID idempotency key. When present, the server guarantees at-most-once execution for the same key+endpoint within 24 hours. | [Optional] [Defaults to `undefined`] |

### Return type

[**LinkMobileUserResponse**](LinkMobileUserResponse.md)
...
import type { ListMobileUsersRequest } from '';
...
async function example() {
  ...
  try {
    const data = await api.listMobileUsers(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
[**MobileUserListItemPagedResult**](MobileUserListItemPagedResult.md)
...
## listMobileUsersForSide

> Array&lt;SideMobileUserListItem&gt; listMobileUsersForSide(sideId, xCorrelationId)
...
import type { ListMobileUsersForSideRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies ListMobileUsersForSideRequest;

  try {
    const data = await api.listMobileUsersForSide(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
[**Array&lt;SideMobileUserListItem&gt;**](SideMobileUserListItem.md)
...
> resetMobileUserPassword(id, resetMobileUserPasswordRequest, xCorrelationId, idempotencyKey)
...
import type { ResetMobileUserPasswordOperationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | UUID idempotency key. When present, the server guarantees at-most-once execution for the same key+endpoint within 24 hours. (optional)
    idempotencyKey: 38400000-8cf0-11bd-b23e-10b96e4ef00d,
  } satisfies ResetMobileUserPasswordOperationRequest;

  try {
    const data = await api.resetMobileUserPassword(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **id** | `string` |  | [Defaults to `undefined`] |
| **resetMobileUserPasswordRequest** | [ResetMobileUserPasswordRequest](ResetMobileUserPasswordRequest.md) |  | |
| **xCorrelationId** | `string` | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. | [Optional] [Defaults to `undefined`] |
| **idempotencyKey** | `string` | UUID idempotency key. When present, the server guarantees at-most-once execution for the same key+endpoint within 24 hours. | [Optional] [Defaults to `undefined`] |
...
| Status code | Description | Response headers |
|-------------|-------------|------------------|
| **204** | No Content |  * X-Correlation-Id - The correlation identifier for this request (echoed or generated). <br>  * Idempotency-Replayed - Set to \&quot;true\&quot; when the response is a replay of a previously completed request. <br>  |
| **401** | Missing or invalid access token |  * X-Correlation-Id - The correlation identifier for this request (echoed or generated). <br>  |
| **403** | Authenticated but missing the required scope |  * X-Correlation-Id - The correlation identifier for this request (echoed or generated). <br>  |
| **404** | Not Found |  * X-Correlation-Id - The correlation identifier for this request (echoed or generated). <br>  |
| **422** | Unprocessable Content |  * X-Correlation-Id - The correlation identifier for this request (echoed or generated). <br>  |
...
## unlinkMobileUserFromSide

> unlinkMobileUserFromSide(sideId, userId, xCorrelationId)
...
import type { UnlinkMobileUserFromSideRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies UnlinkMobileUserFromSideRequest;

  try {
    const data = await api.unlinkMobileUserFromSide(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
> MobileUserDetailResponse updateMobileUser(id, updateMobileUserRequest, xCorrelationId)
...
import type { UpdateMobileUserOperationRequest } from '';
...
async function example() {
  ...
  const body = {
    ...
    // string | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. (optional)
    xCorrelationId: xCorrelationId_example,
  } satisfies UpdateMobileUserOperationRequest;

  try {
    const data = await api.updateMobileUser(body);
    console.log(data);
  } catch (error) {
    console.error(error);
  }
...
|------------- | ------------- | ------------- | -------------|
| **id** | `string` |  | [Defaults to `undefined`] |
| **updateMobileUserRequest** | [UpdateMobileUserRequest](UpdateMobileUserRequest.md) |  | |
| **xCorrelationId** | `string` | Optional correlation identifier for distributed tracing. If omitted, the server generates one. Echoed back in the response. | [Optional] [Defaults to `undefined`] |
